-- module pris sur https://github.com/Srlion/Custom-SAM-Modules
...
local BanMessage = "Contourner un bannissement en utilisant un partage familial. (Compte propriétaire du jeu: %s)"
