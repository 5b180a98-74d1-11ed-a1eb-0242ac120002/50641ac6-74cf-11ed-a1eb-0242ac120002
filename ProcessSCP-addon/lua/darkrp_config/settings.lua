...
GM.Config.demotetime                    = 200
-- doorcost - Sets the cost of a door.
GM.Config.doorcost                      = 2147483647
...
GM.Config.DefaultWeapons = {
    ...
    "gmod_tool",
    "weapon_physgun",
    "anim_swep", // added from an addon. These are toggle fists
    "weapon_hands", // added from an addon. These are toggle fists
    "hl2_fists", // added from an addon. These are toggle fists
}
