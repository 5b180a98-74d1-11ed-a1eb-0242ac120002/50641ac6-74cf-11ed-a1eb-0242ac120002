-- form here https://github.com/WilliamVenner/glua-material-avatar/blob/master/material-avatar.lua
table.insert(process.credits, "https://github.com/WilliamVenner/glua-material-avatar/blob/master/material-avatar.lua")

local AVATAR_IMAGE_CACHE_EXPIRES = 86400 -- 1 day, in seconds

function process.getAvatarMaterial(steamid64, callback)
