...
hook.Add( "HUDPaint", "GuthSCP:HUDPaint", function()
    ...
    local lvl = ent:GetNWInt( "GuthSCP:LVL", 0 )
    if lvl > 0 and GuthSCP.keycardAvailableClass[ ent:GetClass() ] then
        ...
        draw.SimpleText( "Niveau : " .. lvl - 1, "DermaDefault", ScrW() / 2, ScrH() / 2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
    end
end )